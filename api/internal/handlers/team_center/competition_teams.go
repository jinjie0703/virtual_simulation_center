...
type CompetitionTeamResponse struct {
	team_center.CompetitionTeam
...
func GetAllCompetitionTeams(c *gin.Context) {
	...
	var response []CompetitionTeamResponse
	for _, team := range competitionTeams {
		response = append(response, CompetitionTeamResponse{
