// api/internal/models/slide.go (建议之后把文件名也改成 home_page_carousel.go)
...
func (HomePageCarousel) TableName() string {
	return "home_page_carousel"
}